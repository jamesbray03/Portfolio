...
def generate_portfolio_html(projects):
    ...
    print(f"Portfolio page generated at {os.path.join(PORTFOLIO_DIR, 'index.html')}")
...
for item in os.listdir(BASE_DIR):
    ...
    if os.path.isdir(item_path) and item != "_Portfolio":
        ...
        thumbnail_path = os.path.join(item_path, "_media", "thumbnail.png")
